<p align="center">
  <picture><source media="(prefers-color-scheme: light)" srcset="https://shieldcn.dev/header/glow.svg?title=Core&amp;subtitle=Learn+how+to+configure+Linkdirecte.&amp;logo=lu%3AHeart&amp;mode=light&amp;theme=blue&amp;align=left" /><img alt="Auth and sessions | Learn how to configure Linkdirecte." src="https://shieldcn.dev/header/glow.svg?title=Core&amp;subtitle=Learn+how+to+configure+Linkdirecte.&amp;logo=lu%3AHeart&amp;mode=dark&amp;theme=blue&amp;align=left" /></picture>
</p>
